...
add_arg('configs',              str,    'configs/conformer_v16.yml',   'configs file')
...
add_arg('save_model_path',      str,    'uaspeechmodel/refiner_v16/',  'model save path')
add_arg('log_dir',              str,    'uaspeechmodel/logs/refiner_v16/', 'VisualDL log path')
